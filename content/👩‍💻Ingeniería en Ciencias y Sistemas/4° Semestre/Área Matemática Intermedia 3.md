...
modified: 2026-08-07T20:34:57.283Z
---
...
```button
name 📘 Actividades para el curso
type link
action obsidian://open?vault=StudyUniverse&file=%E2%9A%92%EF%B8%8FActividades%20Pendientes%2F%F0%9F%91%A9%E2%80%8D%F0%9F%92%BBIngenier%C3%ADa%20en%20Ciencias%20y%20Sistemas%2F4%C2%B0%20Semestre%20ICS%2FIntermedia%203
color default
customTextColor #FFFFFF
```

```button
name Nota → Matemática 
type note(My New Note, tab) template
action Clase
folder 🟦Matemática/Intermedia 3
prompt true
color blue
```

```button
name Cuaderno General → Intermedia 3
type link
action obsidian://open?vault=StudyUniverse&file=%F0%9F%91%A9%E2%80%8D%F0%9F%92%BBIngenier%C3%ADa%20en%20Ciencias%20y%20Sistemas%2F4%C2%B0%20Semestre%2FCuaderno%20General%2FCuaderno%20General%20%E2%86%92%20Intermedia%203
color default
customTextColor #FFFFFF
```
...
| No.2 | ![ |300](https://i.imgur.com/6Dr1ZWW.png) | Comentarios |
| ---- | ------------------------------------------ | ----------- |
...
| ---- | ----------------------------------------------------- | ----------- |
| 4.1  | [[Modelos Lineales: Problemas con Valores Iniciales]] |             |

| No.1 | ![ |300](https://i.imgur.com/D7sLI0u.png) | Comentarios |
| ---- | ------------------------------------------ | ----------- |
| 5.1  | [[Métodos de Euler y Análisis de Error]]   |             |
| 5.2  | [[Métodos de Euler Mejorado]]              |             |
...
- [Lista de Videos](https://youtube.com/playlist?list=PL-yPtyRdTQ2xYfv6sLyVc9fskH1CcRiwh\&si=JAa4m2LL9XYPVEX2) - Del Curso de Intermedia 3
- [Exámenes del Departamento](https://mate.ingenieria.usac.edu.gt/clavesExamenes/MI3)
